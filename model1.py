...
# Using outlier detection inorder to check if any exceptional cases are present
...
# Checking the Accuracy based the test and train data
...
# Implemented RandomizedSearchCV to check further proximities
...
# Best results were produced by Regressor 
...
# Checking for the model prediction
